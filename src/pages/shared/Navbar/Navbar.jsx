...
const Navbar = () => {
    ...
    const Link = <>
...

        {
            user && <>
                {
                    isAdmin ? <li><NavLink className="hover:text-yellow-500" to={'/dashboard/adminHome'}>DASHBOARD</NavLink></li> :
                        <li><NavLink className="hover:text-yellow-500" to={'/dashboard/userHome'}>DASHBOARD</NavLink></li>
                }
